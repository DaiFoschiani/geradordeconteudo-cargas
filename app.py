...
def llm_generate(llm, prompt):
    template = ChatPromptTemplate.from_messages([
        ("system", "Você é um especialista em transportes da ANTT com foco em SEO e escrita persuasiva."),
        ("human", "{prompt}"),
    ])
...
st.set_page_config(page_title="Gerador de conteúdo- Transportes de cargas 🤖", page_icon="🤖")
st.title("Gerador de conteúdo- Transporte de cargas")

# Campos do formulário
topic = st.text_input("Tema:", placeholder="Ex: Segurança rodoviária para caminhoneiros, Novas regulamentações para veículos de carga, etc.")
...
audience = st.selectbox("Público-alvo:", ['Caminhoneiros (Geral)', 'Motoristas autônomos', 'Empresas de Frota', 'Profissionais de Logística', 'Recém-Habilitados (D/E)'])
cta = st.checkbox("Incluir CTA (Chamada para ação)")
hashtags = st.checkbox("Retornar Hashtags")
keywords = st.text_area("Palavras-chave (SEO):", placeholder="Ex: RNTRC, Saúde do motorista, Tempo de descanso, Multas...")
